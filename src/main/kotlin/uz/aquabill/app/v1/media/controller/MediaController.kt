package uz.aquabill.app.v1.media.controller
...
import uz.aquabill.app.common.ApiResponse as AppApiResponse
import uz.aquabill.app.v1.media.model.dto.BreadcrumbDto
import uz.aquabill.app.v1.media.model.dto.MediaDto
import uz.aquabill.app.v1.media.model.dto.MediaListResponse
import uz.aquabill.app.v1.media.model.dto.MediaUploadResponse
import uz.aquabill.app.v1.media.model.mapper.MediaMapper
import uz.aquabill.app.v1.media.service.MediaService
...
class MediaController(
    ...
    fun createDirectory(
        ...
        parentPath: String
    ): ResponseEntity<AppApiResponse<String>> {
        print(directoryName+" "+parentPath)
        val directoryPath = mediaService.createDirectory(directoryName, parentPath)
        return ResponseEntity.ok(AppApiResponse.success("Directory created successfully", directoryPath))
    }
    ...
    fun getBreadcrumbs(
        ...
        path: String
    ): ResponseEntity<AppApiResponse<List<BreadcrumbDto>>> {
        val breadcrumbs = mediaService.getBreadcrumbs(path)
        return ResponseEntity.ok(AppApiResponse.success("Breadcrumbs retrieved successfully", breadcrumbs))
    }
    ...
    fun listDirectory(
        ...
        pageable: Pageable
    ): ResponseEntity<AppApiResponse<MediaListResponse>> {
        val response = mediaService.listDirectory(path, pageable)
        return ResponseEntity.ok(AppApiResponse.success("Directory contents retrieved successfully", response))
    }
