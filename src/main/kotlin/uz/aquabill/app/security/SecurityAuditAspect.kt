...
class SecurityAuditAspect(
    ...
    @Around("execution(* uz.aquabill.app.modules.v1.admin.controller.AdminController.*(..))")
    ...
    @Around("execution(* uz.aquabill.app.modules.v1.auth.controller.AuthenticationController.authenticateUser(..))")
