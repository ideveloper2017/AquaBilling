package uz.aquabill.app.modules.v1.payment.service

import org.springframework.data.domain.Page
import org.springframework.data.domain.Pageable
import org.springframework.stereotype.Service
import org.springframework.transaction.annotation.Transactional
import uz.aquabill.app.modules.v1.invoice.service.InvoiceService
import uz.aquabill.app.modules.v1.payment.dto.CreatePaymentRequest
import uz.aquabill.app.modules.v1.payment.dto.PaymentDto
import uz.aquabill.app.modules.v1.payment.dto.UpdatePaymentRequest
import uz.aquabill.app.modules.v1.payment.exception.PaymentNotFoundException
...
import uz.aquabill.app.modules.v1.payment.repository.PaymentRepository
...
class PaymentService(
    ...
    private val orderService: InvoiceService,
    ...
    fun getPaymentsByOrderId(orderId: Long): List<PaymentDto> {
        return paymentRepository.findByInvoiceIdAndStatusAndDeletedFalse(orderId, PaymentStatus.COMPLETED)
...
//        val order = orderService(request.orderId)
