package uz.aquabill.app.modules.v1.payment.controller
...
import uz.aquabill.app.modules.v1.payment.service.PaymentService
...
//        val payment = paymentService.createPayment(request, user)
        return ResponseEntity.ok(ApiResponse.success( "Payment created successfully",null))
    }
