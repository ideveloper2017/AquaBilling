package uz.aquabill.app.modules.v1.media.controller
...
import uz.aquabill.app.modules.v1.media.model.dto.BreadcrumbDto
import uz.aquabill.app.modules.v1.media.model.dto.MediaDto
import uz.aquabill.app.modules.v1.media.model.dto.MediaListResponse
import uz.aquabill.app.modules.v1.media.model.dto.MediaUploadResponse
import uz.aquabill.app.modules.v1.media.model.mapper.MediaMapper
import uz.aquabill.app.modules.v1.media.service.MediaService
...
class MediaController(
    ...
    fun uploadFile(
        ...
        directory: String
    ): ResponseEntity<uz.aquabill.app.common.ApiResponse<MediaUploadResponse>?> {
        ...
        return ResponseEntity.ok()
            ...
            .body(uz.aquabill.app.common.ApiResponse.success("File uploaded successfully", response))
    }
    ...
    fun getAllMedia(
        ...
        pageable: Pageable
    ): ResponseEntity<uz.aquabill.app.common.ApiResponse<List<MediaDto>>?> {
        val response = mediaService.getAllMedia(pageable)
        return ResponseEntity.ok(uz.aquabill.app.common.ApiResponse.success("Successfully retrieved media files", response))
    }
    ...
    fun createDirectory(
        ...
        parentPath: String
    ): ResponseEntity<uz.aquabill.app.common.ApiResponse<String>> {
        print(directoryName+" "+parentPath)
        val directoryPath = mediaService.createDirectory(directoryName, parentPath)
        return ResponseEntity.ok(uz.aquabill.app.common.ApiResponse.success("Directory created successfully", directoryPath))
    }
    ...
    fun getBreadcrumbs(
        ...
        path: String
    ): ResponseEntity<uz.aquabill.app.common.ApiResponse<List<BreadcrumbDto>>> {
        val breadcrumbs = mediaService.getBreadcrumbs(path)
        return ResponseEntity.ok(uz.aquabill.app.common.ApiResponse.success("Breadcrumbs retrieved successfully", breadcrumbs))
    }
    ...
    fun listDirectory(
        ...
        pageable: Pageable
    ): ResponseEntity<uz.aquabill.app.common.ApiResponse<MediaListResponse>> {
        val response = mediaService.listDirectory(path, pageable)
        return ResponseEntity.ok(uz.aquabill.app.common.ApiResponse.success("Directory contents retrieved successfully", response))
    }
